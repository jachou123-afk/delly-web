...
最新修正：[V87.14 批次讀取與限流接續保存](TESTING_V87_14.md)；保留 [V87.13 驗算保存與既有問題帶入](TESTING_V87_13.md)、[V87.12 發送前問題與修正導引](TESTING_V87_12.md)及 [V87.11 第二次檢查與快速發送工作台](TESTING_V87_11.md)。新版驗證與部署狀態以各版文件為準；歷史交接文件保留原樣。
